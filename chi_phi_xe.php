...
<div class="page-wrapper">
    ...
    <div class="card">
        <div class="card-header">
            <h1>🔧 Chi phí xe</h1>
            <p>Ghi nhận các khoản chi phí sửa chữa, bảo dưỡng và vận hành xe</p>
        </div>
        ...
        <thead><tr>
            ...
            <th width="120">Số CT</th><th width="110">Biển số</th>
            <th width="130">Loại chi phí</th><th width="120">Số tiền</th>
            <th width="130">Người chi</th><th>Ghi chú</th>
        </tr></thead>
        <tbody id="tableBody">
        <?php
        $loaiBadge = ['Sửa chữa'=>'loai-sc','Bảo dưỡng'=>'loai-bd','Xăng dầu'=>'loai-xd','Phí đường bộ'=>'loai-pb','Phí cầu phà'=>'loai-cp','Bảo hiểm'=>'loai-bh','Đăng kiểm'=>'loai-dk'];
        $stt=1;
        ...
        <tr onclick="selectRow(this)"
            ...
            <td><span class="plate"><?=htmlspecialchars($r['bien_so']??'')?></span></td>
