...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Group headers */
        .th-group-info   { background: #f0f4ff !important; color: #3730a3 !important; }
        .th-group-price  { background: #fff7ed !important; color: #9a3412 !important; }
        .th-group-salary { background: #f0fdf4 !important; color: #166534 !important; }

        th {
            padding: 10px 14px; text-align: center;
            font-size: 11px; font-weight: 700;
            text-transform: uppercase; letter-spacing: .6px; color: #8892a4;
            border-right: 1px solid #eef0f7; white-space: nowrap;
            background: #f8f9fc;
        }
        ...
        td {
            ...
            border-right: 1px solid #f3f4f8; white-space: nowrap; text-align: center;
        }
        ...
        .route-name { font-weight: 600; color: #1a1f36; text-align: left; }
        ...
        .time-text { font-size: 12px; color: #6b7280; font-variant-numeric: tabular-nums; }

        /* Price / salary cells */
        .price-cell  { text-align: right !important; font-weight: 600; color: #92400e; }
        .salary-cell { text-align: right !important; font-weight: 600; color: #166534; }
        .zero-cell   { color: #d1d5db !important; }

        /* Divider between price group and salary group */
        ...
        .modal-box { background: #fff; border-radius: 16px; width: 780px; max-width: 96vw; overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,.2); animation: slideUp .22s ease; }
...
function deleteSelected() {
    if (!selectedId) { alert('Vui lòng chọn một tuyến đường để xóa!'); return; }
